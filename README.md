...
In this course I optimized the ChatBot program from a memory management perspective. There were a total of five specific tasks to be completed, which are detailed below.
